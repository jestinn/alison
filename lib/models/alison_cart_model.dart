...
//
//     final alisonCartModel = alisonCartModelFromJson(jsonString);

import 'dart:convert';

AlisonCartModel alisonCartModelFromJson(String str) =>
    AlisonCartModel.fromJson(json.decode(str));

String alisonCartModelToJson(AlisonCartModel data) =>
    json.encode(data.toJson());

class AlisonCartModel {
  final int? success;
  ...
  factory AlisonCartModel.fromJson(Map<String, dynamic> json) =>
      AlisonCartModel(
